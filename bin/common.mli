...
val x : t -> Build_api.Api.Context_name.t option
...
val config : t -> Build_api.Api.Config.t
...
val instrument_with : t -> Build_api.Api.Lib_name.t list option
...
val config_term : Build_api.Api.Config.t Cmdliner.Term.t

val display_term : Build_api.Api.Config.Display.t option Cmdliner.Term.t

val context_arg : doc:string -> Build_api.Api.Context_name.t Cmdliner.Term.t
