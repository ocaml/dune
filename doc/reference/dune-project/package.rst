...
.. describe:: (package ...)
   ...
   .. describe:: (documentation (depends <dep-specification>))

      Dependencies to build the docs of the package, as
      :token:`~pkg-dep:dep_specification`. This will allow the package's doc to
      reference other packages and libraries in the generated documentation of
