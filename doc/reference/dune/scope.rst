...
packages should be visible. All public libraries from the specified packages
become accessible. Private libraries (those without a ``public_name``) are
never visible through scope stanzas.
