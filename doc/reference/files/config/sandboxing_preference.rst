...
preferences. Dune will try to utilize a setting satisfying both
conditions.
...
-  ``hardlink`` uses hard links for sandboxing. This is the default
   under Linux.
-  ``copy`` copies files for sandboxing. This is the default under
   Windows.
