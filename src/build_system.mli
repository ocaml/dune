...
(** [eval_glob t ~dir glob ~f] returns the list of files in [dir] that matches
    [glob] to [f]. The list of files includes the list of targets. *)
val eval_glob : dir:Path.t -> Glob.t -> string list
