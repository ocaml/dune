...
(* A part of [Super_context.t] sufficient to construct [Env_node]s. *)
module Env_nodes : sig
  ...
  let create ~context ~host_env_nodes ~scopes ~default_env ~stanzas_per_dir
