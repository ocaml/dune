...
and Exported : sig
  ...
  let digest_sandbox_mode d = function
    | None -> Digest.Manual.int d 0
    | Some Sandbox_mode.Symlink -> Digest.Manual.int d 1
    | Some Sandbox_mode.Copy -> Digest.Manual.int d 2
    | Some Sandbox_mode.Hardlink -> Digest.Manual.int d 3
    | Some Sandbox_mode.Patch_back_source_tree -> Digest.Manual.int d 4
  ;;
  ...
  let digest_corrections d = function
    | None -> Digest.Manual.int d 0
    | Some Corrections.Ignore -> Digest.Manual.int d 1
    | Some Corrections.Produce -> Digest.Manual.int d 2
  ;;
  ...
  let compute_rule_digest
    ...
    let digest =
      ...
      digest_sandbox_mode d sandbox_mode;
      ...
      digest_corrections d corrections;
