...
let popular_platform_envs =
  let make ~os ~arch ?os_distribution ?os_family () =
    ...
    env
  in
  [ make ~os:"linux" ~arch:"x86_64" ~os_distribution:"ubuntu" ~os_family:"debian" ()
  ; make ~os:"linux" ~arch:"arm64" ~os_distribution:"ubuntu" ~os_family:"debian" ()
  ; make ~os:"linux" ~arch:"x86_64" ~os_distribution:"alpine" ~os_family:"alpine" ()
  ; make ~os:"linux" ~arch:"arm64" ~os_distribution:"alpine" ~os_family:"alpine" ()
  ; make ~os:"linux" ~arch:"x86_64" ()
  ; make ~os:"linux" ~arch:"arm64" ()
  ; make ~os:"macos" ~arch:"x86_64" ~os_distribution:"homebrew" ~os_family:"homebrew" ()
  ; make ~os:"macos" ~arch:"arm64" ~os_distribution:"homebrew" ~os_family:"homebrew" ()
  ; make ~os:"win32" ~arch:"x86_64" ~os_distribution:"cygwin" ~os_family:"windows" ()
  ; make ~os:"win32" ~arch:"arm64" ~os_distribution:"cygwin" ~os_family:"windows" ()
  ]
;;
