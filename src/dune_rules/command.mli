...
(** Process actions generated by this module may run in an action runner by
    default. [forbid_action_runner] is the escape hatch for generated toolchain
    commands that must stay local, such as compilation and plain ocamldep. *)
