...
val lock_dir_path : Context_name.t -> Path.Build.t option Memo.t
...
val dev_tool_ocamlpath : Context_name.t -> Dune_pkg.Dev_tool.t -> Path.t list Memo.t
val find_package : Context_name.t -> Package.Name.t -> unit Action_builder.t option Memo.t
val dev_tool_env : Context_name.t -> Dune_pkg.Dev_tool.t -> Env.t Memo.t
