...
(** The goal of the [Resolve] monad is to delay library related errors until we
    ...
    [Build_system.prefix_rules] provides a hassle free way to do this, allowing
    one to "inject" a failure in each rule generated by a piece of code. In the
    end the code should looking this this:
    ...
    {[
      ...
      | Error () ->
        ...
        Build_system.prefix_rules fail ~f:(fun () -> gen_rules libs)
    ]} *)
