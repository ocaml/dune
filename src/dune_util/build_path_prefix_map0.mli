...
(** The [DEPLOY_PATH_PREFIX_MAP] variable *)
val _DEPLOY_PATH_PREFIX_MAP : Env.Var.t

(** [extend_deploy_path_prefix_map env how map] extends the path rewriting rules
    encoded in the [DEPLOY_PATH_PREFIX_MAP] variable.
    ...
    whether the rules in [map] should be tried before or after the existing
    ones. *)
val extend_deploy_path_prefix_map :
     Env.t
  -> [ `Existing_rules_have_precedence | `New_rules_have_precedence ]
  -> Build_path_prefix_map.map
  -> Env.t
