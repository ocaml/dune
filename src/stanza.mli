...
module Parser : sig
  ...
  type nonrec t = string * t list Galach.Of_sexp.t
end
...
val file_kind : unit -> (File_kind.t, _) Galach.Of_sexp.parser

(** Overlay for [Galach.Of_sexp] where lists and records don't require
...
module Of_sexp : sig
  include module type of struct include Galach.Of_sexp end
