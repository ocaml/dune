...
(** Indicate the field/constructor being parsed was deleted in the
    given version *)
val deleted_in : t -> Version.t -> (unit, _) Galach.Of_sexp.parser

(** Indicate the field/constructor being parsed was renamed in the
    given version *)
val renamed_in : t -> Version.t -> to_:string ->  (unit, _) Galach.Of_sexp.parser

(** Indicate the field/constructor being parsed was introduced in the
    given version *)
val since : t -> Version.t ->  (unit, _) Galach.Of_sexp.parser
...
val set
  :  t
  -> Version.t
  -> ('a, 'k) Galach.Of_sexp.parser
  -> ('a, 'k) Galach.Of_sexp.parser

val get_exn : t -> (Version.t, 'k) Galach.Of_sexp.parser
