  $ env ORIG_PATH="$PATH" PATH="$PWD/ocaml-bin:$PATH" dune build @all --display short
      ocamldep bin/.toto.eobjs/dune__exe__Toto.impl.d
      ocamldep src/.foo.objs/foo.impl.d
      ocamldep bin-with-build-info/.print_version.eobjs/dune__exe__Print_version.impl.d
