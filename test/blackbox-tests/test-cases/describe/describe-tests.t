...
---------
  ...
  $ dune describe tests --help | head -8
  DUNE-DESCRIBE-TESTS(1)            Dune Manual           DUNE-DESCRIBE-TESTS(1)
  
  NNAAMMEE
         dune-describe-tests - Print out the tests defined in the project.
  
  SSYYNNOOPPSSIISS
         dduunnee ddeessccrriibbee tteessttss [_O_P_T_I_O_N]…
