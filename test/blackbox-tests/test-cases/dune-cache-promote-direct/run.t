  ...
  > EOF
  $ cp dune-v1 dune
  $ env DUNE_CACHE=enabled DUNE_CACHE_TRANSPORT=direct DUNE_CACHE_EXIT_NO_CLIENT=1 XDG_RUNTIME_DIR=$PWD/.xdg-runtime XDG_CACHE_HOME=$PWD/.xdg-cache dune build t2
          bash t1
  running
          bash t2
  running
