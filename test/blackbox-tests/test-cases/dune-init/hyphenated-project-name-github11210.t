...
Invalid project names should still be rejected:
  ...
  Usage: dune init project [--help] [OPTION]… NAME [PATH]
  dune: NAME argument: invalid project name `invalid.name' Project names must
        start with a letter and be composed only of letters, numbers, '-' or
        '_'
  [1]
