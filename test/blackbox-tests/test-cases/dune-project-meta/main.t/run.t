...
Package information fields can be overridden per-package:
  ...
  File "dune-project", line 14, characters 1-14:
  14 |  (allow_empty)
        ^^^^^^^^^^^^^
  Error: 'allow_empty' is only available since version 3.0 of the dune
  language. Please update your dune-project file to have (lang dune 3.0).
  [1]

  $ cat test2/foo.opam
  cat: test2/foo.opam: No such file or directory
  [1]
...
-----------------------------------------------
  ...
  File "dune-project", line 4, characters 21-34:
  4 | (package (name test) (allow_empty))
                           ^^^^^^^^^^^^^
  Error: 'allow_empty' is only available since version 3.0 of the dune
  language. Please update your dune-project file to have (lang dune 3.0).
  [1]
  $ cat gen-v1.11/test.opam
  cat: gen-v1.11/test.opam: No such file or directory
  [1]
...
---------
  ...
  > (name foo)
  > (generate_opam_files true)
  > (package (name foo) (depends bar) (allow_empty))
  > EOF
