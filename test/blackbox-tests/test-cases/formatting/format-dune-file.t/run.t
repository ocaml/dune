...
For dune-lang >= 3.23, multi-line block strings are preserved:
...
Block strings can be used for multi-line bash commands (>= 3.23):
...
Using block strings for long bash commands (>= 3.23) preserves line breaks:
