...
For dune-lang >= 3.25, multi-line block strings are preserved:

  $ dune format-dune-file --dune-version 3.25 <<EOF
  > (echo "\> multi
  >       "\> line
  >       "\> string
  >       "\| string
...
Using block strings for long bash commands (>= 3.25) preserves line breaks:
