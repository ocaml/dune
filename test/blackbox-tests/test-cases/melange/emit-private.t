Test dependency on a private library in the same package as melange.emit
  ...
  $ OCAMLPATH=$PWD/prefix/lib/:$OCAMLPATH dune build @dist
  $ find _build/default/b/dist/ -type f | sort
  _build/default/b/dist/b/bar.js
  _build/default/b/dist/node_modules/pkg.__private__.a/foo.js
