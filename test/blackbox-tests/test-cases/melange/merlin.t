 Temporary special merlin support for melange only libs
  ...
  $ ENCODED_MELC_COMPILER=$(dune_cmd encode-prefix "$melc_compiler")
  $ export BUILD_PATH_PREFIX_MAP=\
  > "MELC_COMPILER=$ENCODED_MELC_COMPILER:$BUILD_PATH_PREFIX_MAP"

  $ melc_stdlib="$(ocamlfind query melange)"
  $ ENCODED_MELC_STDLIB=$(dune_cmd encode-prefix "$melc_stdlib")
  $ export BUILD_PATH_PREFIX_MAP=\
  > "MELC_STDLIB=$ENCODED_MELC_STDLIB:$BUILD_PATH_PREFIX_MAP"
