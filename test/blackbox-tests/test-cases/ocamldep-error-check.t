Dune uses ocamldep to prevent a module from depending on itself.
  ...
  -> required by _build/default/lib/.foo.objs/byte/foo__Bar.cmi
  -> required by _build/default/lib/.foo.objs/native/foo__Bar.cmx
  -> required by _build/default/lib/foo.a
