Duplicate mld's in the same scope
  $ dune build @doc --display short --root ./same-scope 2>&1 | grep -v Entering
        ...
        ocamlc lib2/.root_lib2.objs/root_lib2.{cmt,cmi,cmo}
          odoc _doc/_odoc/lib/root.lib2/root_lib2.odoc
        ocamlc lib1/.root_lib1.objs/root_lib1.{cmt,cmi,cmo}
...
Duplicate mld's in different scope
  ...
  $ dune build @doc --display short --root ./diff-scope 2>&1 | grep -v Entering
          odoc _doc/_html/odoc.css
        ocamlc scope1/.scope1.objs/scope1.{cmt,cmi,cmo}
        ...
        ocamlc scope2/.scope2.objs/scope2.{cmt,cmi,cmo}
