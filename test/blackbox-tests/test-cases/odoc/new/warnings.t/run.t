...
In release mode, no error:
  ...
  (cd _build/default/_doc_new/odoc/foo_doc && odoc compile -o page-foo.odoc ../../../foo_doc/foo.mld -I ../../index/foo_doc --parent 'page-"foo_doc"')
  File "../../../foo_doc/foo.mld", line 4, characters 0-0:
  Warning: End of text is not allowed in '[...]' (code).
  (cd _build/default/_doc_new/odoc/foo_lib && odoc compile -I . -o foo.odoc ../../../foo_lib/.foo.objs/byte/foo.cmti -I ../../index/foo_lib --parent 'page-"foo_lib"')
  File "foo_lib/foo.mli", line 1, characters 7-7:
  Warning: End of text is not allowed in '[...]' (code).
