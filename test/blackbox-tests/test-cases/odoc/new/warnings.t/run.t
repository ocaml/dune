...
In release mode, no error:
  ...
  (cd _build/default/_doc_new && odoc compile -I odoc/local/foo_lib -I odoc/stdlib -o odoc/local/foo_lib/foo.odoc ../foo_lib/.foo.objs/byte/foo.cmti -I index/local/foo_lib --parent 'page-"foo_lib"')
  File "foo_lib/foo.mli", line 1, characters 7-7:
  Warning: End of text is not allowed in '[...]' (code).
  (cd _build/default/_doc_new && odoc compile -o odoc/local/foo_doc/page-foo.odoc ../foo_doc/foo.mld -I index/local/foo_doc --parent 'page-"foo_doc"')
  File "../foo_doc/foo.mld", line 4, characters 0-0:
  Warning: End of text is not allowed in '[...]' (code).
