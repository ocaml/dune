...
When enabling jsoo options, a different build path is used.  For example,
testing effects with double-translations and javascript strings:
  ...
  >   (js_of_ocaml
  >     (flags
  >       (:standard --effects=double-translation --enable use-js-string)))
  >   (libraries
  >     (instantiate lib2 impl :as lib2_impl)
  >     (instantiate lib2 impl2 :as lib2_impl2)
  >     (instantiate lib impl :as lib_impl)))
