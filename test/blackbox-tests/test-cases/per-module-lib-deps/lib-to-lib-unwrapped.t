...
Create unwrapped library B with two modules:
...
Create unwrapped library A that depends on B, with modules referencing
...
Now change ONLY alpha.mli in the base library:
