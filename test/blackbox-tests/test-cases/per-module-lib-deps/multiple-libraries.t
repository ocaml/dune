...
Create two independent libraries:
...
Create modules that use one library each, plus one that uses neither:
  ...
  > (executable
  >  (name main)
  >  (modules main uses_lib no_use_lib uses_other)
...
Now change ONLY mylib's interface:
