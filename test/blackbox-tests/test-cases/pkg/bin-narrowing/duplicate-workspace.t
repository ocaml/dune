Two workspace packages installing a binary of the SAME name are disambiguated
by the consumer's dependencies: only the declared one is in scope, so there is
