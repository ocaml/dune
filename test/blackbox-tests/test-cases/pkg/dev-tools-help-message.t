...
COMMANDS
       ocamlearlybird [OPTION]… [ARGS]…
           Wrapper for running ocamlearlybird intended to be run automatically
           by a text editor. All positional arguments will be passed to the
           ocamlearlybird executable (pass flags to ocamlearlybird after the
           '--' argument, such as 'dune tools exec ocamlearlybird -- --help').

       ocamlformat [OPTION]… [ARGS]…
           Wrapper for running ocamlformat intended to be run automatically by
           a text editor. All positional arguments will be passed to the
       ...
       odig [OPTION]… [ARGS]…
           Wrapper for running odig intended to be run automatically by a text
           editor. All positional arguments will be passed to the odig
