...
In truthy context, the variable is also left for build time evaluation. It
should evaluate to false at solve time, eliminating dead code:
...
"?then:else" syntax uses catch_undefined_var to handle undefined. It should
simplify to "disable" at solve time:
...
Currently the conditional is left for build time:
