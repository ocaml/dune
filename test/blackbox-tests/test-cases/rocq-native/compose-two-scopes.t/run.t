  ...
  lib_root: [
    "_build/install/default/lib/coq/user-contrib/b/.coq-native/Nb_b.cmi" {"coq/user-contrib/b/.coq-native/Nb_b.cmi"}
    "_build/install/default/lib/coq/user-contrib/b/.coq-native/Nb_b.cmxs" {"coq/user-contrib/b/.coq-native/Nb_b.cmxs"}
