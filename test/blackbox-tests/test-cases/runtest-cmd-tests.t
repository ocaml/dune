...
Running tests by specifying ML files directly:
  ...
  2 |  (names test1 test2)
                    ^^^^^
  Running test2
  Fatal error: exception Assert_failure("test2.ml", 3, 2)
  [1]
...
Targeting the entry point:
  ...
  Fatal error: exception Assert_failure("single_test.ml", 3, 2)
  [1]
...
Targeting entry points A and E should run those specific tests:
  ...
  Fatal error: exception Assert_failure("a.ml", 3, 2)
  [1]
  ...
  Fatal error: exception Assert_failure("e.ml", 3, 2)
  [1]
