Test detection of common typos in package dependencies
  ...
  $ dune build
  File "dune-project", line 5, characters 2-19:
  5 |   (bar (= version))  ; Should detect typo and suggest :version
        ^^^^^^^^^^^^^^^^^
  ...
  (bar (= :version)))
  File "dune-project", line 6, characters 2-18:
  6 |   (baz :with_test)   ; Should detect typo and suggest :with-test
        ^^^^^^^^^^^^^^^^
