...
No env
  ...
  $ dune build @cc28 | sed "s,${O_CC} ${O_CCF} ${O_CCPPF} -Wall -fdiagnostics-color=always,OK,"
  OK
...
With added env flags
  ...
  $ dune build @cc28 | sed "s,${O_CC} ${O_CCF} ${O_CCPPF} -Wall -fdiagnostics-color=always -fPIC,OK,"
  OK
