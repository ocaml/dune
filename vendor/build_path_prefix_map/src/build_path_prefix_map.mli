...
val map_pair : (path_prefix -> path_prefix) -> pair -> pair
(** [map_pair f pair] applies the mapping f to each
    path_prefix in the pair, returning the resulting pair. *)

val map_map : (path_prefix -> path_prefix) -> map -> map
(** [map_map f map] applies the mapping f to each
    path_prefix in the map, returning the resulting map. *)
